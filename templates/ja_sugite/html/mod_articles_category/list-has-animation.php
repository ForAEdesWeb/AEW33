...
<ul class="category-module-list category-module<?php echo $moduleclass_sfx; ?>">
<?php if ($grouped) : ?>
	...
	<?php endforeach; ?>
<?php else : ?>
	<?php $delay= 200; foreach ($list as $item) : ?>
	    <li class="ja-animation ja-animate" data-delay="<?php echo $delay; ?>" data-animation="fadeIn">
    ...
    <?php if ($item->displayDate) : ?>
			<i class="fa fa-clock-o"></i><span class="mod-articles-category-date"><?php echo $item->displayDate; ?></span>
		<?php endif; ?>
		</div>
